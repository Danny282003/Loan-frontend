...
import { Eye, EyeOff, Mail, Lock, User, Phone, ArrowRight, DollarSign } from 'lucide-react';
      ...
      <div className="w-full max-w-6xl grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:flex flex-col justify-center space-y-6 p-8">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-4xl font-bold text-gray-800">LoanApp</h1>
          </div>
          
          <h2 className="text-4xl font-bold text-gray-800 leading-tight">
            Quick Loans,<br />
            <span className="text-green-600">Easy Approval</span>
          </h2>
          
          <p className="text-gray-600 text-lg">
            Get the financial support you need, when you need it. Fast approval, flexible repayment, and transparent terms.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-700">Fast approval in 24 hours</span>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
          ...
          <div className="md:hidden flex items-center justify-center space-x-3 mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-800">LoanApp</h1>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-11 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all outline-none"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          disabled={loading}
          className={`w-full font-semibold py-3.5 px-4 rounded-lg transition-all flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl ${
          loading 
